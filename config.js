...
window.CITY = {
  ...
  nombre: "Iquique",
  sigla: "I",
  lat0: -20.2824, lon0: -70.1103,
  comunas: ["Iquique", "Alto Hospicio"],
  comunasGeojson: "comunas_iquique.geojson",
  live: true,
  liveBase: "https://storage.googleapis.com/iquique-transporte-live/",
  demanda: false,
  repo: "transportepublicoIquique",
